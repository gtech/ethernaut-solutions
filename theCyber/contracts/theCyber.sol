...
contract theCyber {
  ...
  function newMember(uint8 _memberId, bytes32 _memberName, address _memberAddress) public membersOnly {
    ...
    emit NewMember(_memberId, _memberName, _memberAddress);
  ...
  function changeName(bytes32 _newMemberName) public membersOnly {
    ...
    emit NewMemberName(addressToMember_[msg.sender], _newMemberName);
  ...
  function changeKey(string _newMemberKey) public membersOnly {
    ...
    emit NewMemberKey(addressToMember_[msg.sender], _newMemberKey);
  ...
  function transferMembership(address _newMemberAddress) public membersOnly {
    ...
    emit MembershipTransferred(addressToMember_[msg.sender], _newMemberAddress);
  ...
  function proclaimInactive(uint8 _memberId) public membersOnly {
    ...
    emit MemberProclaimedInactive(_memberId, addressToMember_[msg.sender]);
  ...
  function heartbeat() public membersOnly {
    ...
    emit MemberHeartbeated(addressToMember_[msg.sender]);
  ...
  function revokeMembership(uint8 _memberId) public membersOnly {
    ...
    emit MembershipRevoked(_memberId, addressToMember_[msg.sender]);
  ...
  function broadcastMessage(string _message) public membersOnly {
    // Log the message.
    emit BroadcastMessage(addressToMember_[msg.sender], _message);
  }
  ...
  function directMessage(uint8 _toMemberId, string _message) public membersOnly {
    // Log the message.
    emit DirectMessage(addressToMember_[msg.sender], _toMemberId, _message);
  }
  ...
  function passMessage(address _contractAddress, string _message) public membersOnly {
    ...
    emit Call(addressToMember_[msg.sender], _contractAddress, _message);
  ...
  function donateFunds() public membersOnly {
    ...
    emit FundsDonated(addressToMember_[msg.sender], this.balance);
  ...
  function donateTokens(address _tokenContractAddress) public membersOnly {
    ...
    emit TokensDonated(addressToMember_[msg.sender], _tokenContractAddress, ERC20(_tokenContractAddress).balanceOf(this));
